...
\title{Household Finances\thanks{Ram K Rijal, Universität Bonn. Email: \href{mailto:s6rarija@uni-bonn.de}{\nolinkurl{s6rarija [at] uni-bonn [dot] de}}.}}
...
\begin{abstract}
    The paper was done by Professor Joshua Angrist. 
\end{abstract}
\clearpage
...
The following exercise will try to unpack the methods and work out the solution using python.  you are using this template, please cite this item from the references: \citet{GaudeckerEconProjectTemplates}
